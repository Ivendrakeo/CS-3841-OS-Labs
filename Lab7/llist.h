...
/* 
 * Helper method which prints the list's contents to the console
 * 
 * myList : pointer to the list which should be printed.
 * 
 * return : void
 */ 
...
/* 
 * Helper method which prints the list's head and tail to the console
 * to verify the head and tail are what they should be.
 * 
 * myList : pointer to the list which should be printed.
 * 
 * return : void
...
/* 
 * Helper method which get's a node pointer for a supplied position in 
 * the linked list.
 * 
 * myList : pointer to the list which should be printed.
 * position : valid position in the list for which you would like the pointer of
 * 
 * return : pointer to the node at position in supplid myList
 */ 
node* getNode(list* myList, int position);

/* 
 * Method which "cleans up" the list before destructing it.
 * Free's the memory associated with the internal mutex.
 * 
 * myList : pointer to the list
 */ 
